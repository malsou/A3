...
% Cooling requirement calibration
opts.cool_phi_den = 9500;
opts.cool_phi_offset = 0.001;
opts.cool_tmetal_gain = 950;

% TSFC output convention for A3 (lbm/hr/lbf to match HW outputs)
opts.TSFC_unit = "lbm_per_hr_lbf";
